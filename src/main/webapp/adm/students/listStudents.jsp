...
<div class="container-fluid" align="center">
    <div class="form-group" style="text-align: left">
        <form id="searchForm">
            ...
            <input type="hidden" name="columns" value="c_grade">
            ...
            <span class="col-md-2">
				<input type="text" name="values" class="form-control" placeholder="年级">
				</span>
        </form>
        ...
        <button class="btn btn-primary" onClick="openImportForm()">
            <span class="glyphicon glyphicon-import"></span>导入学生</button>
        <button class="btn btn-primary" onClick="location.href='export'">
            <span class="glyphicon glyphicon-export"></span>导出学生</button>
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <h4 class="modal-title" id="importModalLabel">导入学生</h4>
                </div>
    ...
    <div id="app">
        <table class="table table-hover">
            ...
            <tr v-for="data in datas">
                ...
                <td><button title="编辑学生信息"
                    ...
                    <button title="删除学生" @click="del(data.number);">
        ...
        <button class = "btn btn-default btn-sm"
                @click = showData(pages.changePage)>
            <span>确定</span>
            <span class="glyphicon glyphicon-goto"></span>
        </button>
        <button class="btn btn-default btn-sm"
