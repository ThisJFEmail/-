...
<div class="container-fluid" align="center">
    <p align="left">
        <a href="listRoles.jsp">所有学生</a>>>
        <a href="listUsersInRole?rid=${role.id}">${role.name }</a>
        <button class="btn btn-primary" onClick="add();">添加学生</button>
        <button class="btn btn-primary" onClick="del();">删除学生</button>
    </p>
    <div id="app1" class="col-sm-6">
        <p>候选学生</p>
        <form id="form-app1" action="addStudentsToRoleAjax" method="post">
    ...
    <div id="app2" class="col-sm-6">
        <p>已选用户</p>
        <form id="form-app2" action="delStudenytsFromRoleAjax" method="post">
            <input type="hidden" name="rid" value="${role.id }">
            <table class="table table-hover">
                <tr>
                    <th><input type="checkbox" onclick="checkAll(this)">全选</th>
